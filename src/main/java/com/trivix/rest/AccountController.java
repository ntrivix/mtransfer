...
public class AccountController {
    ...
    public void setPaths() {
        path("/account", () -> {
            ...
            post("/:id/deposit/:currency/:amount", (rq, rs) -> changeBalance(rq, rs, BalanceChangeType.DEPOSIT), gson::toJson);
            post("/:id/withdraw/:currency/:amount", (rq, rs) -> changeBalance(rq, rs, BalanceChangeType.WITHDRAW), gson::toJson);
        });
    }

    private Object changeBalance(Request request, Response response, BalanceChangeType balanceChangeType) {
